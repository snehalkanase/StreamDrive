    ...
    >
      ...
      >
        <div className="w-full flex justify-end">
          <button className="text-gray-600 hover:text-red-700" onClick={handleClose}>
            <svg
          ...
          {!uploading ? (
            <>
              ...
              <button
                ...
                className="p-2 rounded-md bg-[#b2d250] hover:scale-105 transition-all duration-200 text-white"
              >
                Choose a File
                <input
                  ref={fileInputRef}
