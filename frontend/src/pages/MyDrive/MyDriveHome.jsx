...
function MyDriveHome({ open, data, data2, isFolderOpen, toggleFolder, preview }) {
  ...
  return (
    <div className="font-inter relative top-14 md:top-16 lg:top-20 p-1 bg-white h-[100%]">
      <div className="flex w-[78%] md:w-[88%] lg:w-[84%] justify-between items-center top-14 md:top-16 lg:top-20 bg-white pt-2 pb-2 z-10 fixed">
