...
function Navbar() {
  ...
  return (
    <nav className="bg-[#009F7A] py-1 px-4 flex justify-between items-center w-10/12 mx-auto rounded-3xl absolute z-50 top-2 md:top-6 left-[50%] translate-x-[-50%]">
      ...
      {isOpen && (
        <div className="lg:hidden absolute top-12 z-0 left-0 right-0 bg-gray-800 p-6 rounded-b-xl shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px]">
          <ul className="flex flex-col items-center space-y-4 text-white">
            ...
            >
              <a href="#" className="hover:text-yellow-400 text-black">
                Pricing
              </a>
            </li>
            <li>
