...
function Auth({ check }) {
  ...
  return (
    ...
    <h1 className="text-2xl md:text-4xl lg:text-4xl ">Welcome to Streamdrive</h1>
<p className="text-gray-400 font-[300] p-2">Your secure cloud storage solution is ready. Start managing your files now.</p>
